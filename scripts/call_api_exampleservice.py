...
# Service endpoints
VERSION_ENDPOINT = '/service/example_service/version'
SCHEMA_ENDPOINT = '/service/example_service/schema'
COMPUTE_ENDPOINT = '/service/example_service/compute'
...
payload = {
    'value': np.random.randint(0, int(1e9)),
